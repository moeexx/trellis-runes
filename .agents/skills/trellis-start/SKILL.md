...
- **Active task status `planning`** → stay in Phase 1. Load the relevant Phase 1 step detail while planning is needed; after review, run `task.py start` (its gate enforces readiness).
